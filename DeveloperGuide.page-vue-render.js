...
with(this){return _c('h3',{attrs:{"id":"track-a-person-owing-money"}},[_v("Track a person owing money"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#track-a-person-owing-money","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_v("In order to better manage a CCA, we created a functionality that allows executive\ncommittee members to track the amount of money a person owes. Take for example this command "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("owe 1 m/10.00")]),_v(".\nAs a result of this command, the first person listed will now owe $10.00.\nThe general steps are:")])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("Check the current list of contacts to see whether the list is "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("null")]),_v(" or not.")]),_v(" "),_c('li',[_v("If it is "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("null")]),_v(", throw an exception, otherwise validate the index.")]),_v(" "),_c('li',[_v("Lastly, validate the amount, ensuring that the amount provided is not blank,\nnegative, or more than 2 decimal places.")])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"payment-splitting"}},[_v("Payment splitting"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#payment-splitting","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("This feature will implement a better internal representation of a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Cca")]),_v(" object. This enables the implementation of certain features such as:")])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("Adding meta-data to CCAs")]),_v(" "),_c('li',[_v("Displaying every contact related to CCAs in a concise manner.")]),_v(" "),_c('li',[_v("Allow more interactive ways to traverse contacts related to CCAs.\n"),_c('ul',[_c('li',[_v("E.g., "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("display CCA")]),_v(" can list every contact (summary) grouped according to roles. Each contact is clickable, which will modify the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ModelManager.filteredPersons")]),_v(" to only have said contact.")])])])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("A better "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model")]),_v(" representation.")])])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"a-better-model-representation"}},[_v("A better "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model")]),_v(" representation"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#a-better-model-representation","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_v("The minimal "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model")]),_v(" changes required to implement this is the implementation of "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("UniqueCcaList")]),_v(" as per above. This represents a half-way point between the ideal "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model")]),_v(" implementation which involves "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("UniqueRoleList")]),_v(".")])}
},function anonymous(
) {
with(this){return _c('p',[_v("This allows "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Cca")]),_v(" objects to contain metadata (such as "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Cca.description: String")]),_v(") that is automatically shared across all members within the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Cca")]),_v(".")])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("model")]),_v(":\n"),_c('ul',[_c('li',[_v("See above diagram.")])])]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("logic")]),_v(":\n"),_c('ul',[_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Command.execute")]),_v(" that use "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Cca")]),_v("s needs to interface with "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ModelManager.UniqueCcaList")]),_v(" to create new "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Cca")]),_v("s as needed or to reuse the object in the list.")])])]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("storage")]),_v(":\n"),_c('ul',[_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("JsonAdaptedCCA")]),_v(" needs to seralise any new fields in "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Cca")]),_v(".")])])]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("test")]),_v(":\n"),_c('ul',[_c('li',[_v("Tests similar to that of "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("UniquePersonList")]),_v(" has to be implemented.")])])])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("Adding meta-data to CCAs. Possible implementation details:\n"),_c('ol',[_c('li',[_v("Have the command format be "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("cca-desc DESC")]),_v(".")]),_v(" "),_c('li',[_v("The creation of a new "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Command")]),_v(" class "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CcaDescCommand")]),_v(".")]),_v(" "),_c('li',[_v("Implementing "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Cca.setDesc")]),_v(".")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CcaDescCommand.execute")]),_v(" will look for the correct "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Cca")]),_v(" object in "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("UniqueCcaList")]),_v(" and call "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Cca.setDesc(desc)")]),_v(".")])])])])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"modification-of-ui-elements-to-display-ccas"}},[_v("Modification of UI elements to display "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Cca")]),_v("s."),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#modification-of-ui-elements-to-display-ccas","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("Renaming of "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("PersonListPanel")]),_v(" to "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("DisplayObjectListPanel")]),_v(".")]),_v(" "),_c('li',[_v("Renaming of "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("PersonListPanel.fxml")]),_v(" to "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("DisplayObjectListPanel.fxml")]),_v(".")]),_v(" "),_c('li',[_v("Add a new "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ListView")]),_v(" in "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("DisplayObjectListPanel.fxml")]),_v(" below "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("personListView")]),_v(" known as "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ccaView")]),_v(".\n"),_c('ul',[_c('li',[_v("Update "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("DisplayObjectListPanel")]),_v(" accordingly.")])])]),_v(" "),_c('li',[_v("Create a new "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CcaCard")]),_v(" object in "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ui")]),_v(" and its corresponding "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CcaCard.fxml")]),_v(" file.")]),_v(" "),_c('li',[_v("Add a new overload "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("updateItem")]),_v(" with type signature "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("(Cca cca, boolean empty)")]),_v(" that appends a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CcaCard")]),_v(" object to "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("PersonListPanel.ccaView")]),_v(".")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("Displaying every contact related to CCAs in a concise manner.\n"),_c('ul',[_c('li',[_v("This will depend on the implementation of "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CcaCard")]),_v(".")])])]),_v(" "),_c('li',[_v("Allow more interactive ways to traverse contacts related to CCAs.")])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"attendance-tracking"}},[_v("Attendance Tracking"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#attendance-tracking","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('h4',{attrs:{"id":"proposed"}},[_v("[Proposed]"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#proposed","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('h4',{attrs:{"id":"proposed-2"}},[_v("[Proposed]"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#proposed-2","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('h3',{attrs:{"id":"proposed-feedback-to-app-developers-and-cca-excos"}},[_v("[Proposed] Feedback to App Developers and CCA Excos"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#proposed-feedback-to-app-developers-and-cca-excos","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("User click on the hyperlink that leads to the Google Form, CCA Manager App feedback form.")]),_v(" "),_c('li',[_v("User fill in the feedback form based on the issues that they have.")]),_v(" "),_c('li',[_v("User submit the feedback form (Google Form)")]),_v(" "),_c('li',[_v("App Developers receive the feedback")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("CCA members click on the hyperlink that leads to the Google form, CCA feedback form.")]),_v(" "),_c('li',[_v("CCA members fill in the feedback form based on the issues that they have.")]),_v(" "),_c('li',[_v("CCA members submit the feedback form (Google form)")]),_v(" "),_c('li',[_v("CCA Exco members receive the feedback")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("has a need to manage a significant amount of CCA information (such as contacts, roles and details)")]),_v(" "),_c('li',[_v("prefer desktop apps over other types")]),_v(" "),_c('li',[_v("can type fast")]),_v(" "),_c('li',[_v("prefers typing to mouse interactions")]),_v(" "),_c('li',[_v("is reasonably comfortable using CLI apps")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Value proposition")]),_v(": manage CCA information faster than a typical mouse/GUI driven app")])}
},function anonymous(
) {
...
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_v("Priority")]),_v(" "),_c('th',[_v("As a …​")]),_v(" "),_c('th',[_v("I want to …​")]),_v(" "),_c('th',[_v("So that I can…​")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("EXCO Member")])]),_v(" "),_c('td',[_v("Assign roles to contacts")]),_v(" "),_c('td',[_v("manage my "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CCA Member")]),_v("s")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CCA Member")])]),_v(" "),_c('td',[_v("Identify the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("EXCO Member")]),_v("s")]),_v(" "),_c('td',[_v("Inform them if I am unable to make it for the CCA session")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("EXCO Member")])]),_v(" "),_c('td',[_v("Form groups of contacts")]),_v(" "),_c('td',[_v("associate who belongs to what CCA")])]),_v(" "),_c('tr',[_c('td'),_v(" "),_c('td'),_v(" "),_c('td'),_v(" "),_c('td')]),_v(" "),_c('tr',[_c('td'),_v(" "),_c('td'),_v(" "),_c('td'),_v(" "),_c('td')]),_v(" "),_c('tr',[_c('td'),_v(" "),_c('td'),_v(" "),_c('td'),_v(" "),_c('td')])])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("(For all use cases below, the "),_c('strong',[_v("System")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CCA Manager")]),_v(" and the "),_c('strong',[_v("Actor")]),_v(" are the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("EXCO Member")]),_v("s and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CCA Member")]),_v("s, unless specified otherwise)")])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"uc01-assign-roles-to-contacts"}},[_v("UC01 - Assign roles to contacts"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#uc01-assign-roles-to-contacts","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('pre',[_c('code',{pre:true,attrs:{"class":"hljs"}},[_c('span',[_v("1.  User requests to list contacts\n")]),_c('span',[_v("2.  `CCA Manager` shows a list of contacts\n")]),_c('span',[_v("3.  User requests to assign role to the contact\n")]),_c('span',[_v("4.  `CCA Manager` assigns role to that contact\n")]),_c('span',[_v("Use case ends.\n")])])])}
},function anonymous(
) {
...
with(this){return _c('pre',[_c('code',{pre:true,attrs:{"class":"hljs"}},[_c('span',[_v("1.  User requests to list contacts\n")]),_c('span',[_v("2.  `CCA Manager` shows a list of contacts\n")]),_c('span',[_v("3.  User requests to form a group for a list of contacts\n")]),_c('span',[_v("4.  `CCA Manager` forms a group for a list of contacts\n")]),_c('span',[_v("Use case ends.\n")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('pre',[_c('code',{pre:true,attrs:{"class":"hljs"}},[_c('span',[_v("2a. Provided Non-Integer input for `Index of Contacts`.\n")]),_c('span',[_v("    2a1. `CCA Manager` shows an error message.\n")]),_c('span',[_v("    Use case resumes at step 2\n")]),_c('span',[_v("\n")]),_c('span',[_v("3a. Provided Integer that is out of range of index\n")]),_c('span',[_v("    3a1. `CCA Manager` shows an error message.\n")]),_c('span',[_v("    Use case resumes at step 2\n")]),_c('span',[_v("\n")]),_c('span',[_v("4a. Invalid `Group Name`\n")]),_c('span',[_v("    Use case ends.\n")]),_c('span',[_v("\n")]),_c('span',[_v("5a. Invalid `Index of Contacts`\n")]),_c('span',[_v("    Use case ends.\n")])])])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"uc03-identify-the-exco-members"}},[_v("UC03 - Identify the EXCO members"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#uc03-identify-the-exco-members","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('pre',[_c('code',{pre:true,attrs:{"class":"hljs"}},[_c('span',[_v("1.  User requests to view the contacts in the EXCO group\n")]),_c('span',[_v("2.  AddressBook shows a list of contacts in the EXCO group\n")]),_c('span',[_v("Use case ends.\n")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('em',[_v("{More to be added}")])])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_v("Compatibility:\n"),_c('ol',[_c('li',[_v("Should work on any "),_c('em',[_v("mainstream OS")]),_v(" as long as it has Java "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("11")]),_v(" or above installed.")])])]),_v(" "),_c('li',[_v("Performance:\n"),_c('ol',[_c('li',[_v("Should be able to hold up to 1000 persons without a noticeable sluggishness in performance for typical usage.")]),_v(" "),_c('li',[_v("GUI should respond/provide feedback within 2s.")])])]),_v(" "),_c('li',[_v("Usability:\n"),_c('ol',[_c('li',[_v("A user with above average typing speed for regular English text (i.e. not code, not system admin commands) should be able to accomplish most of the tasks faster using commands than using the mouse.")]),_v(" "),_c('li',[_v("A new user should be able to navigate the functionality of the program with ease.")]),_v(" "),_c('li',[_v("The GUI should be readable with sufficient contrast between UI elements.")])])]),_v(" "),_c('li',[_v("Process:\n"),_c('ol',[_c('li',[_v("The project is expected to adhere to a schedule that delivers a feature set every one month.")])])]),_v(" "),_c('li',[_v("Constraints:\n"),_c('ol',[_c('li',[_v("The project should be implementable in 4 weeks.")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('em',[_v("{More to be added}")])])}
},function anonymous(
...
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Mainstream OS")]),_v(": Windows, Linux, Unix, MacOS")]),_v(" "),_c('li',[_c('strong',[_v("Private contact detail")]),_v(": A contact detail that is not meant to be shared with others")]),_v(" "),_c('li',[_c('strong',[_v("CCA Manager")]),_v(": The name used to refer to this project")]),_v(" "),_c('li',[_c('strong',[_v("CCA")]),_v(": Refers to the student organisation which "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CCA Manager")]),_v(" intends to simplify the administration of.")]),_v(" "),_c('li',[_c('strong',[_v("EXCO Member")]),_v(": A target user group. Refers to a member that is in-charge of the organisation of a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CCA")]),_v(".")]),_v(" "),_c('li',[_c('strong',[_v("CCA Member")]),_v(": A target user group. Refers to a member that partakes in the activities of a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CCA")]),_v(".")]),_v(" "),_c('li',[_c('strong',[_v("Contact")]),_v(": An object that refers to a person. It is the core object of administration in "),_c('strong',[_v("CCA Manager")]),_v(".")]),_v(" "),_c('li',[_c('strong',[_v("Role")]),_v(": Part of the metadata of a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("contact")]),_v(". It classifies a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("contact")]),_v(" based on their responsibilities in the CCA.")]),_v(" "),_c('li',[_c('strong',[_v("Group")]),_v(": Part of the metadata of a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("contact")]),_v(". It allows "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("contact")]),_v("s to be organised in groups the user can manage seperately.")])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.4.0")]),_v(", generated on Wed, 17 Apr 2024, 12:42:21 GMT+8]")])])])}
}];
